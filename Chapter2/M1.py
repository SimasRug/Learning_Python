...
amt_certificate = 10#float(input('Enter amount of the gift certificate: '))

print('Enter ordered items for person 1')

appetizer_per1 = 1#float(input('Appetizer: '))
entree_per1 = 1#float(input('Entree: '))
drinks_per1 = 1#float(input('Drinks: '))
dessert_per1 = 1#float(input('Dessert:'))


print('Enter ordered items for person 2')

appetizer_per2 = 1#float(input('Appetizer: '))
entree_per2 = 1#float(input('Entree: '))
drinks_per2 = 1#float(input('Drinks: '))
dessert_per2 = 1#float(input('Dessert:'))
